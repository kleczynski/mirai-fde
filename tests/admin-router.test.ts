...
describe('shared admin deployment adapter', () => {
  const postRoutes = ['session', 'delete-session', 'session-note', 'session-export', 'session-trace', 'voice-health', 'invitations', 'hosted-demo-detail', 'hosted-demo-update', 'hosted-demo-feedback-handled'];
